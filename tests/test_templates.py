...
@pytest.mark.parametrize("model_func", ["sklearn.svm.SVC", "sklearn.linear_model.Perceptron"])
...
def test_sklearn_code(model_func, data_format, scale_mean_std, visualization_tool, tmp_path):
